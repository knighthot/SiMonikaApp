// Data/Tambak.js (sesuaikan path sesuai strukturmu)
import { getRandomSensorData } from '../Utils/randomSensor'; // pastikan 'Utils' benar
...
export const penerimaTambak = {
  ...
  Substrat: '-',
  ID_Perangkat: '-', // kalau mau masuk join dev999, ganti ke 'DEV999'
...
export default tambakWithPerangkat;